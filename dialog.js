...
function renderDialogContent(pokemon, color) {
  let html = `
    ...
    <div class="dialog_nav">
        ...
        <button class="dialog_nav_button" style="background:${color};" data-id="next-button" onclick="nextPokemon()"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><use href="#chevron-right"></use></svg></button>
    </div>`;
